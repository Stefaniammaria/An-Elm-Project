...
type SelectedEventCategories = 
    ...
    --SelectedEventCategories{isAcademic : Bool,
                            --isWork : Bool,
                            --isProject : Bool,
                            --isAward : Bool}
...
allSelected =
    TODOCompleteThisType
    --SelectedEventCategories.isAcademic = True &&
    --SelectedEventCategories.isWork = True &&
    --SelectedEventCategories.isProject = True &&
    --SelectedEventCategories.isAward = True
...
noneSelected =
    TODOCompleteThisType
    --SelectedEventCategories.isAcademic = False &&
    --SelectedEventCategories.isWork = False &&
    --SelectedEventCategories.isProject = False &&
    --SelectedEventCategories.isAward = False 
